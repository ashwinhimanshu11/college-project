    ...
    return (
        <div>
            ...
            <section className="about-section">
                ...
                We are committed to transparency and accuracy in our data collection and analysis, and we strive to provide the most up-to-date and reliable information possible to our users. We also believe that education and community engagement are essential components of our mission, and we work closely with local organizations to raise awareness and promote environmental stewardship.<br />

                Thank you for visiting our website and for your interest in our mission. We welcome your feedback and suggestions, and we look forward to working with you to create a cleaner and healthier environment for all.
            </section>
        </div>
    );
};
